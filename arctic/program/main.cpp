...
while (true) {
  ...
  Ink(selected == 0 ? 8 : 1);
  Print(10, 50, "Two-number!");
  Ink(selected == 1 ? 8 : 1);
  Print(10, 50, "Three-number!");
  Ink(selected == 2 ? 8 : 1);
  Print(10, 50, "Four-number!");
  Ink(selected == 3 ? 8 : 1);
  Print(10, 30, "EXIT");
...
while (true) {
  ...
  Print(10, 80, "Minus");
  Ink(selected == 2 ? 8 : 1);
  Print(10, 70, "Addition");
  Ink(selected == 3 ? 8 : 1);
  Print(10, 50, "Subtraction");
  Ink(selected == 4 ? 8 : 1);
  Print(10, 30, "Menu");
...
labelGame:
  ...
  ResizeScreen(150, 150);
      ...
      Si32 o = Number(Input(50, 50,"Вeдите число: "));
  ...
  while (!IsKeyDownward(kKeyEscape)) {
      ...
      o = Number(Input(50, 50,"Ввeдите число: "));
